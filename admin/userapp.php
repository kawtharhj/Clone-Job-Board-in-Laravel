                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="locationchart.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">User's Applications</li>
                        </ol>

                     
    <?php 
    require('db.php');
    $sql = "SELECT listings_id,firstname,lastname, email, phone,cv FROM jobs";
    $result = mysqli_query($connect, $sql);

    if (mysqli_num_rows($result) > 0) {
        $folder_path = 'C:\xampp\htdocs\fromY\public\cvs';
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>".$row['cv']."</td>";
            echo "<td><a href='public/cvs/".basename($folder_path."/".$row['cv'])."' download>Download</a></td>";
         echo "</tr>";
        }
...
.styled-table {
            ...
            min-width: 400px;
            box-shadow: 0 0 20px #A8A8AC;
        }

        .styled-table thead tr {
            background-color: #080768;
            color: #ffffff;
            text-align: left;
        }
