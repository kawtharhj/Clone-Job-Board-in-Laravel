...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard-Jobs List</li>
                        </ol>

                     
    <?php 
    require('db.php');
    $sql = "SELECT id,title, company, location, website, email, tags FROM listings";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='removejob.php?id=" . $row['id'] . "' class='btn btn-danger'>Remove</a></td>";
